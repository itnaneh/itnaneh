        ...
        <div className="contact__content">
            ...
            <div className="contact__info">
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">Itnaneh@gmail.com</span>
                    <a href="mailto:itnaneh@gmail.com" target='__blank' className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button"></i></a>
                </div>
                ...
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">itnane_h</span>
                    <a href="https://www.instagram.com/itnane_h/" target='__blank' className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button"></i></a>
                </div>
            </div>
        </div>
...
<button className="button button--flex" id='btn'>
            Send Message
            <svg
                  class="button__icon"
